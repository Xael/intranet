                ...
                <form onSubmit={handleAddSaida} className="p-4 bg-light rounded-lg border space-y-4">
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 items-end">
                        <div>
                         ...
                         <div><label className="block text-sm font-medium">Quantidade</label><input type="number" name="quantidade" value={newSaida.quantidade} onChange={handleFormChange} required className="mt-1 w-full border-gray-300 rounded-md shadow-sm"/></div>
    ...
    return (
        <div className="space-y-4">
            <div className="p-4 bg-light rounded-lg border grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                ...
                <input type="number" value={simulacaoQtd} onChange={e => setSimulacaoQtd(e.target.value)} min="1" className="w-full border-gray-300 rounded-md" placeholder="Quantidade" />
...
const ControleMateriais: React.FC<ControleMateriaisProps> = ({ data, setData, simulacoesSalvas, setSimulacoesSalvas }) => {
 ...
 useEffect(() => {
    // Set initial filter only if data is loaded and no filter is set
  ...
  const handleMunicipioChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    setFiltroEditalIdx('0'); // Reset edital to the first one when municipality changes
  };
